...
# from ast import Nonlocal, parse
...
# def hex2rgb(hexcode):
#     return type(map(ord,hexcode[1:].decode('hex')))
...
#         return 'completed!'
#     return 'incorret image mode, llllllllll'
...
#                 if(binary[-5:]=='#####'):
#                     print('success')
#                     return bin2str(binary[:-5])
#         return bin2str(binary)
#     return 'incorrect imageno de '

# def Main():
#     parser=optparse.OptionParser('usage %prog'+'-e/d <targat file>')
